...
async function main() {
  ...
  await page.route("**/api/social-trends/collect", route => route.fulfill({status:201,contentType:"application/json",body:JSON.stringify({ok:true,result:{keyword:"智己L6",statusHint:"已形成可识别热度",confidence:.8,confidenceLabel:"高",snapshot:{id:"social-release-gate"},items:[{id:"e1"}],platforms:[{platform:"douyin",label:"抖音",contentCount:1,heat:78,positive:1,negative:0},{platform:"xiaohongshu",label:"小红书",contentCount:0,heat:0,positive:0,negative:0},{platform:"weibo",label:"微博",contentCount:0,heat:0,positive:0,negative:0}],hotWords:[{word:"智能座舱",count:3}],ownModelRanking:[{model:"智己L6",heat:78,contentCount:1}],positiveCompetitorsTop5:[],contentRanking:[{platformLabel:"抖音",text:"智己L6 智能座舱体验",author:"汽车媒体",sourceUrl:"https://www.douyin.com/video/1",matrixContent:true,heat:78,sentiment:"positive",evidence:{contentHash:"1234567890abcdef"}}],methodology:{heat:"可复算热度口径"},qa:{dualModel:{status:"aligned"},strategyOutput:"基于双模型一致证据形成策略结论"}}})}));
