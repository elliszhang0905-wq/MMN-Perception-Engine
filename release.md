...
- 发布版本：`beta-1.02-20260719-global-readiness-2`；全板块功能提交：`cab9914`。
...
- ECS 于 2026-07-19 02:57（Asia/Shanghai）完成重建；6 个服务全部运行，0 个不健康服务，近 10 分钟错误日志为 0。
...
- 发布前回滚点：`backups/code_before_cab9914_20260719_025558.tar.gz`、`backups/env_before_cab9914_20260719_025558`、`backups/mmn_backup_20260719_025615.tar.gz`。服务器原有车型上市日期和 `/app/data` 持久化业务数据均已保留。
