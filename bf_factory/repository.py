...
class BFRepository:
    ...
    def _seed_template_profiles(self, conn):
        seeds = (
            ...
            ("STATIC_SHOOT", "静态实拍", ["PROJECT_BACKGROUND", "PRODUCT_POINT_DISTRIBUTION", "SCENE_PLAN", "STATIC_EXPERIENCE", "SHOT_LIST", "VEHICLE_LOGISTICS", "MATERIAL_RETURN", "RISK_CONTROL", "DELIVERY"]),
            ("DYNAMIC_SHOOT", "动态实拍", ["PROJECT_BACKGROUND", "CORE_VALUE", "SCENE_PLAN", "DYNAMIC_MATERIAL_CAPTURE", "SHOT_LIST", "VEHICLE_LOGISTICS", "MATERIAL_RETURN", "RISK_CONTROL", "DELIVERY"]),
            ("CHASSIS_SHOOT", "底盘实拍", ["PROJECT_BACKGROUND", "CORE_VALUE", "CHASSIS_DETAIL_CAPTURE", "SHOT_LIST", "VEHICLE_LOGISTICS", "MATERIAL_RETURN", "RISK_CONTROL", "DELIVERY"]),
        )
        timestamp = _now()
