...
- Git应用基线：当前候选已重放到 GitHub `main` 的 `59cf1d6` 之上，保留抖音逐视频证据链生产闭环与云端在线安全发布防护，版本目标为 `beta-1.03-20260731-policy-energy-contract-1`；最终 GitHub 提交、ECS 标记与归档哈希须在生产收口后补记。
