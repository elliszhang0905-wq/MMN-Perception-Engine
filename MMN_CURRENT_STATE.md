...
- 状态包版本：`v2.52`
- 最后核验时间：`2026-08-10`（Asia/Shanghai，周度车市扫描月末格式生产闭环）
- Git应用基线：生产运行 `beta-1.03-20260810-weekly-market-scan-1`，应用提交 `108582e5490ac4162d7e8eac2eab7d4a8e8eb600` 已进入 GitHub `main` 并由同提交归档部署至 ECS。
