...
- 2026-08-10 周度车市扫描月末格式本地发布候选：官网最新《车市扫描(20260727-0731)》省略同比月份并将“新能源零售渗透率”改写为“新能源市场零售渗透率”，原解析器因此失败；月末周截至7月31日而非周日8月2日，原新鲜度校验也会阻止发布。候选提交 `6adeffec693f0c1cd9bff1650aaa40486b2937b5` 兼容两类同比措辞、两类渗透率措辞和同一完成周内的月末截断，同时在下一自然周未发布时保留最后有效快照。42项定向Python测试、管理看板UI契约、真实官网抓取、临时数据目录刷新接口及1440px/390px浏览器验收通过；生产尚未部署，线上仍为 `latest_parse_failed`。
