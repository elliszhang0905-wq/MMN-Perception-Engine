...
- 状态包版本：`v2.37`
- 最后核验时间：`2026-07-30`（Asia/Shanghai，决策驾驶舱车型内容热度证据生产闭环）
- Git应用基线：应用提交 `685d61f0a5ca5837e609a51185c03fb310b5e09b` 已同步功能分支、GitHub `main`、标签 `beta-1.03-20260730-dashboard-vehicle-heat-1`、本地8765与ECS；服务器 `.deployed-git-commit`、健康版本和六个关键文件哈希一致。GitHub `main` 可在本状态包提交后仅领先纯文档闭环，不代表应用代码漂移。
- 当前分支：应用发布源位于隔离分支 `codex/mmn-dashboard-dy-rank-20260730`；本地8765从该已提交工作树运行，ECS使用同一提交归档部署。
