...
- 状态包版本：`v2.45`
- 最后核验时间：`2026-07-31`（Asia/Shanghai，政策车型能源契约生产闭环）
- Git应用基线：政策车型能源契约运行提交 `5f57059cac880cb1e6174a17990f906c5f01e4ca` 已进入 GitHub `main` 并部署 ECS，运行版本为 `beta-1.03-20260731-policy-energy-contract-1`；精确发布归档 SHA-256 为 `15eaed1e338ff04111d8ced413fee85a254a7a5dd86836e08487f9d4d5cebb94`。
- 当前分支：发布源与生产验收证据位于隔离分支 `fix/policy-energy-contract-20260731`；现有 LS6 脏工作树及其数据库未纳入发布归档。
