...
- 状态包版本：`v2.34`
- 最后核验时间：`2026-07-29`（Asia/Shanghai，本轮全板块收口候选）
...
- 当前分支：生产仍运行 `codex/douyin-radar-metrics-20260729` 对应的应用提交；全板块收口候选位于隔离分支 `codex/mmn-full-deploy-closure-20260729`，未通过完整门禁、真实双端流程与生产验收前不得写成已发布。
