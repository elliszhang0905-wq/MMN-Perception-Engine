...
- 状态包版本：`v2.30`
- 最后核验时间：`2026-07-25`（Asia/Shanghai）
- Git应用基线：生产应用提交为 `70d17d501d289683555a4227f1ba47f4f08de197`；GitHub `main`、发布分支与 ECS 运行包已同步。
- 当前分支：`fix/douyin-insight3-release-20260725`；应用版本为 `beta-1.03-20260725-video-insight-retry-1`。
