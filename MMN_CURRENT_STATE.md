...
- Git应用基线：生产应用提交为 `eeb881f4000f1eb6c32de16c1df6bc1e431e600f`；GitHub `main`、发布分支与 ECS 运行包已同步。
- 当前分支：`codex/security-zero-drift-20260724`；应用版本为 `beta-1.03-20260724-security-boundary-2`。
