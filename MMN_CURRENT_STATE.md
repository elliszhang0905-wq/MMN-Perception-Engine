...
- 状态包版本：`v2.40`
- 最后核验时间：`2026-07-30`（Asia/Shanghai，政策车型自动审核生产闭环）
- Git应用基线：政策功能提交为 `eaade9cdc164dd6d194cc8a5a333db4de5d2d005`；当前生产运行其直接后继提交 `fafa8cf782cb1cecc461f1f3a89664da43ced9d0`，版本 `beta-1.03-20260730-douyin-video-evidence-chain-1`。后继提交只叠加抖音证据链修复和版本标识，政策前后端、销量资产与本工单合同未改动；两提交均已进入 GitHub `main`。
- 当前分支：发布源位于隔离分支 `codex/policy-auto-audit-20260730`；ECS使用同一应用提交归档同步，用户其它脏工作树未被纳入发布包。
