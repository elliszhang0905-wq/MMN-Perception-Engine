...
- Git应用基线：ECS 运行应用提交为 `dca9f42a9c333557bbb74bccc9f8c7d7b04e47c6`；GitHub `main` 包含该运行提交及其后的纯文档闭环提交。生产版本及全局静态资源缓存令牌均为 `beta-1.03-20260727-audit-hardening-1`。
- 当前分支：生产发布工作树位于干净分支 `release/mmn-audit-legacy-20260727`；审计实现 `6a39eb706af5ededf19296da1b3704b2e401b6c5`、本地归档 `079321dd3b49b5759a8730337045b3b32af1e517` 与生产主线已通过合并提交 `4027fe3` 汇合。
