...
- Git应用基线：运行应用代码仍为 `685d61f0a5ca5837e609a51185c03fb310b5e09b`，版本 `beta-1.03-20260730-dashboard-vehicle-heat-1`；GitHub `main`、本地8765和ECS源代码目录已同步本状态包所在的统一收口提交。健康版本不因纯文档/Handoff收口虚假升级。
- 当前分支：统一发布源位于隔离分支 `release/mmn-unified-sync-20260730`；本地8765从该干净工作树运行，ECS使用同一提交归档同步。
