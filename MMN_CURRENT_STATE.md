...
- 生成时工作树状态：应用代码、测试与研发档案已提交；当前只保留本次 handoff 文档收口，以及原有 `data/`、日志、截图、`output/`、`tmp/`、用户文档和既有未跟踪备份，后者继续排除，不进入 GitHub 或 ECS 归档。
...
- 当前未提交内容仅为本次发布 handoff 文档收口；`data/` 下本地备份/状态、日志、截图、`output/` 与 `tmp/` 不进入本次 GitHub 或 ECS 发布归档。
